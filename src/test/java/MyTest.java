...
class GameEngineTest {
    ...
    void testCheckTicket() {
        ...
        playerNums = new ArrayList<>(Arrays.asList(1, 2, 3));
        winningNums = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5));
        matches = gameEngine.checkTicket(playerNums, winningNums);
        ...
        playerNums = new ArrayList<>(Arrays.asList(1, 5, 10, 20));
        winningNums = new ArrayList<>(Arrays.asList(1, 10, 30, 40, 50));
